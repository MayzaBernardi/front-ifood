...
const router = useRouter();
    ...
    const handleCadastro = (e) => {
        ...
        console.log("Dados do novo cliente:", { nome, email, dataNascimento, senha, cpf });
    ...
    return (
        ...
        <div className="flex-1 flex justify-center items-center p-6 md:p-20">
            ...
            <form onSubmit={handleCadastro} className="flex flex-col gap-5">
                ...
                <div>
                <label htmlFor="dataNascimento" className="block mb-1.5 text-sm font-semibold text-texto-principal">Data de Nascimento</label>
                <input 
                    type="date" 
                    id="dataNascimento"
